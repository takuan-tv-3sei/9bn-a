...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[21], {
    ...
    3363: function(e, t, r) {
        ...
        let u = s.memo(e => {
            ...
            s.useState)(0)
              , h = (0,
            s.useRef)()
              , [p,{sound: g, duration: m, pause: v, stop: j}] = (0,
            a.Z)(t)
              , b = m ? m / 1e3 : 0
              , f = (0,
            s.useCallback)( () => {
        ...
        let S = () => {
          ...
          , C = e => {
            ...
            v.Z)()
              ...
              , g = c.width / c.height
              , m = p >= g
              , S = m ? (innerHeight - 64) * g : innerWidth - 64
              , C = m ? innerHeight - 64 : (innerWidth - 64) / g
              , k = m ? c.height > C : c.width > S
              , I = k ? S : c.width
              , O = k ? C : c.height;
            (0,
            o.useEffect)( () => {
    ...
    26622: function(e, t, r) {
        ...
        let x = (0,
        i.forwardRef)( (e, t) => {
            let {children: r, mode: l="Default", page: s, maxPage: o, height: d=240, prefixLabel: u, suffixLabel: x, useLatexInLabel: j=!1, useLatexInSuffix: b=!1, hasBackgroundImage: f=!0, onClickLeft: w, onClickRight: y} = e
              , S = (0,
            i.useMemo)( () => {
                switch (l) {
                case "Default":
    ...
    80021: function(e, t, r) {
        ...
        let h = e => {
          ...
          , O = e => {
            let {source: t} = e
              , {parameter: r} = t
              , i = t.audio
              , {targetWord: l, partOfSpeech: s, variantForm: a, baseForm: o, wordUsageAndMeaning: d} = r
              , u = l.split(" ").length;
            return (0,
            n.jsxs)("div", {
                className: "question-area",
                ...
                n.jsx)("p", {
                    className: "question-text",
                    children: "熟語" === s || "名詞" === s && u >= 3 ? "語句を並べかえて次の英語を完成させましょう。" : "文字を並べかえて次の英語を完成させましょう。"
                }), (0,
                n.jsx)("div", {
                    className: "main-text",
                    children: (0,
                    n.jsx)(x.J$, {
                        src: ( () => {
                            switch (a) {
                            case "3単現":
                                return "".concat(o, "の変化形で, 主語が3人称単数で現在の時に使う語");
                            case "過去形":
                                return "".concat(o, "の過去形");
                            case "過去分詞形":
                                return "".concat(o, "の過去分詞形");
                            default:
                                return "".concat(d)
                            }
                        }
          ...
          , E = e => {
            ...
            n.jsxs)("div", {
                ...
                }, "Sub Section:".concat(t))), 0 !== u.length && (0,
                n.jsx)("div", {
        ...
        let q = e => {
            ...
            l.b9)(Z.u)
              , [b,f] = (0,
            s.useState)(!1)
              , {elementRef: w, elementSize: y} = (0,
            o.yU)()
              , S = (0,
            T.R3)()
              , {sendOpenMemoOnReplay: C} = H()
              , k = (0,
            s.useCallback)( () => {
                f(e => {
                    let t = !e;
        ...
        let e$ = () => {
          ...
          , e2 = e => {
            ...
            case "on":
                r = (0,
                eZ.n)("png/icon_check_select_multi_on.png");
                break;
            case "off":
                r = (0,
                eZ.n)("png/icon_check_select_multi_off.png");
                break;
            case "disabled":
                r = (0,
                eZ.n)("png/icon_check_select_multi_disable.png")
            }
            return (0,
            n.jsx)("img", {
                src: r,
        ...
        F.cn)(!1)
          ...
          , tp = e => {
            let {selectables: t, selecting: r, fullSelectRequired: l, correct: o, orientation: c, onAnswered: d} = e
              , {toggle: u, isSelected: x, isSelectable: h, prepare: p, fix: g} = tx(r, o, l)
              , {showing: m, show: v, hide: j} = tc()
              , {show: b, hide: f, visibled: w} = tu()
              , y = (0,
            s.useCallback)( () => {
          ...
          , tN = e => {
            ...
            if (!x || !h || !p)
                return null;
            let g = tM(x.correct, x.answered)
              , m = tM(h.correct, h.answered)
              , v = tM(p.correct, p.answered)
        ...
        s.forwardRef)( (e, t) => {
            ...
            s.useMemo)( () => "eraser" === l, [l])
              , {sendPing: g, opened: m, recognized: v, error: j, init: b, eraseLine: f} = tz(t)
              , w = (0,
            s.useCallback)( () => {
                m(),
                null == o || o()
            ...
            n.jsxs)("div", {
                ...
                n.jsx)(tD, {
                    ...
                    n.jsx)(et(), {
                        src: (0,
                        eZ.n)("png/icon_eraser_cursor.png"),
                        width: 60,
                        height: 60,
                        alt: "eraser"
                    })
        ...
        let tX = (e, t) => {
            ...
            s.useState)(!1)
              ...
              , {currentPopup: b, setPopup: f, hidePopup: w} = tP()
              , y = (0,
            s.useMemo)( () => {
                let e = c.some(e => {
        ...
        rk.Z)(i.Z)(e => {
          ...
          , rJ = e => {
            ...
            o.yU)()
              ...
              , {prepare: b} = rH()
              , {opened: f, recognizing: w, recognized: y, disconnected: S, reconnect: C, answeredText: k, isOpenReconnectMessage: I, isRecognizing: O} = rD()
        ...
        let nk = () => {
          ...
          , n_ = e => {
            ...
            o.yU)()
              , {opened: v, recognizing: j, recognized: b, disconnected: f, reconnect: w, recognizedText: y, isOpenReconnectMessage: S, isRecognizing: C} = ny()
              , {show: k, hide: I, visibled: O} = nI()
              , {show: _, hide: A, visibled: L} = nw()
              , {page: R, maxPage: E, back: Z, forward: T} = nS()
              , {prepare: M, fix: D} = nf()
        ...
        let nZ = e => {
          ...
          , nN = e => {
            ...
            s.useRef)(null)
              , {elementRef: g, elementSize: m} = (0,
            o.yU)()
              , {opened: v, recognizing: j, recognized: b, recognizedError: f, reconnect: w, recognizedText: y, isOpenReconnectMessage: S, isRecognizing: C, appendix: k} = nk()
              , {show: I, hide: O, visibled: _} = nI()
              , {show: A, hide: L, visibled: R} = nw()
              , {page: E, maxPage: Z, back: T, forward: M} = nS()
              , {prepare: D, fix: W} = nf()
        ...
        F.cn)("")
          ...
          , ib = e => {
            ...
            o.yU)()
              , {opened: y, recognizing: S, recognized: C, disconnected: k, reconnect: I, recognizedText: O, isOpenReconnectMessage: _, isRecognizing: A} = im()
              , {show: L, hide: R, visibled: E} = ig()
              , {onPointerDown: Z, onPointerUp: T} = (0,
            eF._n)()
              , M = (0,
            s.useCallback)( () => {
                S(),
        ...
        let iI = e => {
          ...
          , iO = e => {
            let {orientation: t, isPlaying: r, playAudio: i} = e;
            switch (t) {
            case "landscape":
                return (0,
                n.jsxs)(c.sg, {
          ...
          , i_ = iS()( () => Promise.all([r.e(153), r.e(189), r.e(196), r.e(755)]).then(r.bind(r, 60755)).then(e => e.Answering), {
            loadableGenerated: {
                webpack: () => [60755]
            },
            ssr: !1
          ...
          , iA = e => {
            let {replayResource: t, onAnswered: r} = e
              , l = (0,
            T.R3)()
              , {windowHeight: s} = (0,
            eR.A)();
            if (t) {
                let e = t.args.speaking;
                switch (l) {
                case "landscape":
                    return (0,
                    n.jsx)(i.Z, {
        ...
        let iE = e => {
            let {programResource: t, replayResource: r, answerMode: l, answerType: s, pendingAnswerProcess: a, startAnswerProcess: o, endAnswerProcess: c} = e
              ...
              , x = u.apData
              , {sendUnknownAnswerPattern: h, sendAnswerPatternChanged: p, sendInvalidReplayResource: g} = iW()
              , m = () => {
        ...
        iK.displayName = "DescriptionPanel";
        let iY = e => {
                ...
                case "ad_english_word":
                    return function(e) {
                        ...
                        let j = e.args
                          ...
                          , y = null !== (i = j.countability) && void 0 !== i ? i : ""
                          , S = null !== (l = j.base_form) && void 0 !== l ? l : ""
                          ...
                          , Z = null !== (g = j.superlative_degree) && void 0 !== g ? g : void 0
                          , N = null !== (m = j.example_usage) && void 0 !== m ? m : void 0
    ...
    26008: function(e, t, r) {
        ...
        let C = () => {
          ...
          , k = e => {
            ...
            i.b9)(o.Bm)
              , E = (0,
            i.b9)(w.DX)
              , {isLoading: Z, isError: N, sendCursorPauseCommand: T} = (0,
            S.sy)()
              , {facilitators: M} = (0,
            f.v)()
              , D = (0,
        ...
        J.Z)(z.Z)(e => {
          ...
          , $ = () => {
            ...
            W.kk)()
              , r = t();
            return r && 0 !== r.resources.length ? (0,
            n.jsx)(V, {
                explain: r,
                visible: e
            }) : (0,

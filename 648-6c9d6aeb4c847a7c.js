...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[648], {
    ...
    16396: function(e, t, r) {
        ...
        let m = "State Machine"
          ...
          , v = e => {
            var t;
            let {result: r, postPartCountUp: g, height: v=500, width: f=500, portalElem: b=h.L, handleOnPlay: j, handleOnStop: w} = e
              , S = (0,
            s.Dv)(p.q7)
              , [y,C] = (0,
            o.useState)(!1)
            ...
            c.createPortal)((0,
            n.jsx)(l.Z, {
                position: "body" === b ? "fixed" : "absolute",
                width: 1,
                height: 1,
                sx: {
                    inset: "body" === b ? "0 0 0 ".concat(T, "px") : 0,
                    zIndex: _
                },
                children: (0,
                n.jsx)(l.Z, {
            ...
            }), "body" === b ? document.body : null !== (t = document.getElementById(b)) && void 0 !== t ? t : document.body)
        }
        ;
        g.displayName = "Popup"
    },
    ...
    26622: function(e, t, r) {
        ...
        A.displayName = "KatexErrorDialog";
        var O = r(61982)
          , _ = r(85771);
        let N = () => {
            let e = (0,
    ...
    99648: function(e, t, r) {
        ...
        let eJ = () => {
          ...
          , eK = e => {
            let {correct: t, placeHolder: r, orientation: l, onAnswered: o} = e
              ...
              , {show: v, hide: f, visibled: b} = eB()
              , {show: j, hide: w, visibled: S} = e$()
              , y = (0,
            a.useCallback)(e => {
        ...
        a.forwardRef)( (e, t) => {
            ...
            a.useMemo)( () => "eraser" === l, [l])
              , {sendPing: m, opened: g, recognized: v, error: f, init: b, eraseLine: j} = tM(t)
              , w = (0,
            a.useCallback)( () => {
                g(),
                null == o || o()
        ...
        let t$ = (e, t) => {
            ...
            a.useState)(!1)
              ...
              , {currentPopup: b, setPopup: j, hidePopup: w} = tH()
              , S = (0,
            a.useMemo)( () => {
                let e = c.some(e => {
        ...
        let rh = (e, t) => Math.floor(Math.random() * (t - e + 1) + e)
          ...
          , rw = e => {
            ...
            a.useCallback)(e => {
                ...
                l === rb ? W(e.active, e.over) : a === rb ? M(e.active) : Z(e.active, e.over)
            }
            , [Z, M, W])
              , J = (0,
            a.useCallback)(e => {
        ...
        rC.Z)(i.Z)(e => {
          ...
          , rH = e => {
            ...
            o.yU)()
              ...
              , {prepare: b} = rq()
              , {opened: j, recognizing: w, recognized: S, disconnected: y, reconnect: C, answeredText: k, isOpenReconnectMessage: I, isRecognizing: A} = rT()
        ...
        let nC = () => {
          ...
          , nA = e => {
            ...
            o.yU)()
              , {opened: v, recognizing: f, recognized: b, disconnected: j, reconnect: w, recognizedText: S, isOpenReconnectMessage: y, isRecognizing: C} = nw()
              , {show: k, hide: I, visibled: A} = nk()
              , {show: O, hide: _, visibled: N} = nj()
        ...
        let nE = e => {
          ...
          , nL = e => {
            ...
            a.useRef)(null)
              , {elementRef: m, elementSize: g} = (0,
            o.yU)()
              , {opened: v, recognizing: f, recognized: b, recognizedError: j, reconnect: w, recognizedText: S, isOpenReconnectMessage: y, isRecognizing: C, appendix: k} = nC()
              , {show: I, hide: A, visibled: O} = nk()
              , {show: _, hide: N, visibled: R} = nj()
        ...
        P.cn)(!1)
          ...
          , n5 = e => {
            let {apData: t, orientation: r, onAnswered: l} = e
              ...
              , {show: v, hide: f, visibled: b} = n4()
              , {handleChanged: j, getInput: w} = n9()
              , S = (0,
            a.useCallback)(e => {
    ...
    78949: function(e, t, r) {
        ...
        let h = e => {
            ...
            a.useState)(!1)
              , A = (0,
            a.useMemo)( () => b ? "Answered" : w ? "PendingAnswered" : "Answering", [b, w])
              , O = (0,
            a.useMemo)( () => (null == b ? void 0 : b.pagePath) === "cursor/result", [null == b ? void 0 : b.pagePath])
              , _ = (0,
            d.U4)()
              , N = (0,
            d.Fl)()
